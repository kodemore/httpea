...
from .http_headers import HttpHeaders, parse_header
from .http_message import (BinaryHttpMessage, FormHttpMessage, HttpMessage,
                           JsonHttpMessage, MultipartHttpMessage,
                           SimpleHttpMessage, YamlHttpMessage)
    ...
    def as_dict(self) -> dict:
        if self._as_dict is None:
            ...
            try:
                ...
                try:
                    self._as_dict = yaml.safe_load(body_str)  # type: ignore
